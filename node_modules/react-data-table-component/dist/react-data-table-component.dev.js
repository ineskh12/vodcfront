...
var TableCellCheckbox = function TableCellCheckbox(_ref) {
  ...
  var disabled = row[selectableRowsDisabledField]; // eslint-disable-next-line react-hooks/exhaustive-deps
...
var defaultProps = {
  ...
  // Deprecated - superseded by onSelectedRowsChange - will be removed in 5.0
...
var DataTable = React.memo(function (_ref) {
  ...
  }, [currentPage, data.length, handleChangePage, pagination, paginationServer, paginationTotalRows]);
  ...
  }), progressPending && persistTableHead && React__default.createElement(ProgressWrapper, null, progressComponent), !progressPending && data.length > 0 && React__default.createElement(TableBody, {
